...
namespace DataFrontier.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260615052011_AddDocumentosFiscais")]
    partial class AddDocumentosFiscais
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataFrontier.Domain.Entities.ConfiguracaoEmpresa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("AmbienteFiscal")
                        .HasColumnType("integer")
                        .HasColumnName("ambiente_fiscal");
                    ...
                    b.Property<string>("CertificadoNome")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("certificado_nome");

                    b.Property<byte[]>("CertificadoPfx")
                        .HasColumnType("bytea")
                        .HasColumnName("certificado_pfx");
                    ...
                    b.Property<byte[]>("InterCertificadoPfx")
                        .HasColumnType("bytea")
                        .HasColumnName("inter_certificado_pfx");

                    b.Property<string>("InterCertificadoSenha")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("inter_certificado_senha");

                    b.Property<string>("InterClientId")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("inter_client_id");

                    b.Property<string>("InterClientSecret")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("inter_client_secret");
            ...
            modelBuilder.Entity("DataFrontier.Domain.Entities.Pedido", b =>
                {
                    ...
                    b.Property<string>("CodigoVerificacaoNfse")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("codigo_verificacao_nfse");
                    ...
                    b.Property<string>("LinkNfseNacional")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("link_nfse_nacional");

                    b.Property<int?>("NumeroNfe")
                        .HasColumnType("integer")
                        .HasColumnName("numero_nfe");

                    b.Property<long?>("NumeroNfse")
            ...
            modelBuilder.Entity("DataFrontier.Domain.Entities.Produto", b =>
                {
                    ...
                    b.Property<bool>("IsServico")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_servico");
